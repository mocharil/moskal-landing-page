    ...
    <div className="bg-gray-900 rounded-lg border border-gray-800 p-3 md:p-6 h-full">
      <div className="flex justify-between items-center mb-3 md:mb-6">
        <div className="flex items-center gap-1 md:gap-2">
          ...
          <h3 className="font-medium text-xs sm:text-sm md:text-base">Moskal Analytics</h3>
        </div>
        <button
          onClick={refreshData}
        ...
        <div className="flex justify-between items-center mb-2 md:mb-4">
          ...
          {!isVerySmall && (
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div className="flex items-center gap-1">
                <div className="h-1.5 w-1.5 md:h-2 md:w-2 rounded-full bg-blue-500/50"></div>
      ...
      <div className="bg-gray-800/50 p-2 md:p-4 rounded-lg">
        ...
        <div className="space-y-2 md:space-y-3">
          {[
            ...
            { source: isVerySmall ? "Search" : "Organic Search", percentage: 28, color: "bg-blue-500" },
